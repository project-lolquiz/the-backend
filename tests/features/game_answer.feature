Feature: Game answer
  ...
  Scenario: Set right answer for only one user
    ...
    When I request to send the following answers
      | uid                                   | chosen_answer                         |
      | 413e5edd-a297-4edd-9fd5-8f73a3a9a3e2  | 413e5edd-a297-4edd-9fd5-8f73a3a9a3e2  |
      | 4b64074bb-3f11-4235-ae52-81b65a2df1cf | 4b64074bb-3f11-4235-ae52-81b65a2df1cf |
      | 79829961-5483-4d58-a0d1-4332629355dd  | 79829961-5483-4d58-a0d1-4332629355dd  |
  ...
  Scenario: Set right answer for all users
    ...
    When I request to send all the answers with the right choice
      | uid                                  | chosen_answer                        |
      | e75e98c5-a3dd-4c17-9348-4f6b8992fad8 | e75e98c5-a3dd-4c17-9348-4f6b8992fad8 |
      | b6c198f8-d288-4c7b-a195-02b9a1dd734d | e75e98c5-a3dd-4c17-9348-4f6b8992fad8 |
      | 94074753-b02f-425a-a9cd-529cfbc6bc84 | e75e98c5-a3dd-4c17-9348-4f6b8992fad8 |
    Then I should get a 201 http response code
    And I should get a valid answer response
